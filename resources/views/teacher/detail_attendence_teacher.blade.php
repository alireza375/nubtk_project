                        ...
                        <div class="row">
                            <div class="col-md-3 col-4">
                                {{-- <div class="form-group col-md-12">
                                    ...
                                    <input type="date" name="date" id="date" value="{{ $details['0']['date'] }}"
                                    ...
                                    <ol class="breadcrumb">
                                        {{-- <h4>
                                            <a href="{{ route('take.attendence.teacher') }}"
                                                ...
                                                <i class="fas fa-list"></i> Take Attendence</a>
                                        </h4> --}}
                                    </ol>
                                </div>
                            </div><!-- /.col-2 -->
                        ...
                        <table class="table sm table-bordered table-striped dt-responsive" style="width: 100%">
                            <thead>
                                <tr>
                                    ...
                                    <th rowspan="2" class="text-center" style="vertical-align: middle">Course</th>
                                    <th rowspan="2" class="text-center" style="vertical-align: middle">Attendence Date
                                    </th>
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>{{$item['course']['course_name']}} -- {{ $item['course']['course_code'] }}</td>
                                    <td>{{ Carbon\Carbon::parse($item->date)->format('d-m-Y') }}</td>
                                    <td colspan="3">{{ $item->attend_status }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
                        <a href="{{ route('teacher') }}" class="w-100 btn btn-success pb-3"> Back to Dashboard </a>
                    </div>
                    <!-- end card body-->
