                ...
                <div class="card">
                    <div class="card-body mt-5">
                        <form action="{{ route('store.attendence.teacher') }}" method="post" id="myForm">
                            @csrf
                            <input type="number" hidden="" value="{{ Auth::user()->id }}" name="teacher_id">
                            <div class="row">
                                <div class="col-md-3 col-4">
                                    ...
                                    <br>
                                    <div class="form-group col-md-12">
                                        <label for="course_id" class="control-label">Course Id - {{ $course->course_code
                                            }}</label>
                            ...
                            <table class="table sm table-bordered table-striped dt-responsive" style="width: 100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2" class="text-center" style="vertical-align: middle">Course Code
                                        </th>
                                ...
                                <tbody>
                                    ...
                                    <tr id="div {{$student->id}}" class="text-center">
                                        <input type="hidden" name="student_id[]" value="{{$student->stu_id}}"
                                            class="student_id">
