...
<html lang="en">
    ...
    <body class="authentication-bg authentication-bg-pattern">
        ...
        <div class="text-center w-60 m-auto">
            <div class="auth-logo">
                    <span class="logo-lg">
                        <img src="https://nubtkhulna.ac.bd/assets/images/logo.png" alt="" height="52">
                    </span>
       ...
       <footer class="footer footer-alt">
            2023 - <script>document.write(new Date().getFullYear())</script> &copy; Created by <a href="" class="text-white-50">NUBTK</a> 
        </footer>
